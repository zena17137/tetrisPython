...
sc.create_text(505, 30,text="TETRIS", font=("Arial", 47),fill="red", anchor=NW)
sc.create_text(525, 350,text="Score:", font=("Arial", 40),fill="white", anchor=NW)
_score = sc.create_text(545, 410,text=str(score), font=("Arial", 40),fill="white", anchor=NW)
sc.create_text(525, 480,text="Record:", font=("Arial", 40),fill="gold", anchor=NW)
_record = sc.create_text(545, 540,text=record, font=("Arial", 40),fill="white", anchor=NW)
